  ...
  return (
    <section className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className={`grid grid-cols-1 ${isHomePage ? 'md:grid-cols-1' : 'md:grid-cols-2'} gap-8 ${isHomePage ? 'md:gap-8' : 'md:gap-6'} max-w-6xl mx-auto px-4 ${!isHomePage ? 'items-stretch' : ''}`}>
