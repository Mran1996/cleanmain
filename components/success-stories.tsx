    ...
    <section className="py-8 sm:py-12 md:py-16 bg-white w-full">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center mb-6 sm:mb-8 md:mb-10 w-full">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 md:mb-4">Real People. Real Legal Wins.</h2>
          <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-1">Families and self-represented clients across the U.S. use Ask AI Legal to fight back — and win.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-5 md:gap-6 max-w-5xl mx-auto w-full">
          {/* Testimonial 1 */}
          <div className="flex-1 border-2 border-blue-300 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 bg-white flex flex-col items-center shadow-sm">
            <img
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full mb-3 sm:mb-4 md:mb-6 object-cover border-4 border-blue-100"
            />
          ...
          <div className="flex-1 border-2 border-purple-300 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 bg-white flex flex-col items-center shadow-sm">
            <img
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full mb-3 sm:mb-4 md:mb-6 object-cover border-4 border-purple-100"
            />
            <p className="text-gray-900 text-sm sm:text-base md:text-lg text-center mb-4 sm:mb-5 md:mb-6 leading-relaxed">
          ...
          <div className="flex-1 border-2 border-green-300 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 bg-white flex flex-col items-center shadow-sm">
            <img
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full mb-3 sm:mb-4 md:mb-6 object-cover border-4 border-green-100"
            />
            <p className="text-gray-900 text-sm sm:text-base md:text-lg text-center mb-4 sm:mb-5 md:mb-6 leading-relaxed">
