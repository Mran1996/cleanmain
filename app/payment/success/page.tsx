...
// For Full Service one-time purchases, shows the intake form.
function PaymentSuccessInner() {
  ...
  // Check if this is a Full Service purchase
  ...
  // Show success message after intake submission
  if (success) {
    return (
  ...
  // Default success page for subscriptions and other payments
...
// Legacy export - no longer needed as intake is handled in PaymentSuccessInner
